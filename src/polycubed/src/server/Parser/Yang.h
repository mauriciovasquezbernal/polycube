...
class Yang {
 public:
  explicit Yang(const std::string &datamodel,
                ...
                std::unique_ptr<Resources::Data::BaseModel::ConcreteFactory> &&base_model_factory);
 ...
 private:
  ...
  const std::unique_ptr<Resources::Data::BaseModel::ConcreteFactory> base_model_factory_;
