...
//  ListResource(
//      std::function<Response(const char *, const ListKeyValues &keys)>
//          read_entry_handler,
//      std::function<Response(const char *, const ListKeyValues &keys)>
//          read_whole_handler,
...
//      const std::vector<Body::JsonNodeField> &node_fields);
 ...
 private:
  const std::function<Response(const std::string &, const ListKeyValues &keys, const nlohmann::json &)>
      create_entry_handler_;
  const std::function<Response(const std::string &, const ListKeyValues &keys, const nlohmann::json &)>
      replace_entry_handler_;
  const std::function<Response(const std::string &, const ListKeyValues &keys, const nlohmann::json &)>
      update_entry_handler_;
  const std::function<Response(const std::string &, const ListKeyValues &keys)>
      read_entry_handler_;
  const std::function<Response(const std::string &, const ListKeyValues &keys)>
  ...
  const std::function<Response(HelpType, const std::string &, const ListKeyValues &keys)>
      help_;
};
