...
std::shared_ptr<CubeIface> CubeFactoryImpl::create_cube(
  ...
  auto cube = create_cube(name, ingress_code, egress_code, log_msg, type, cb,
                          level);
...
std::shared_ptr<TransparentCubeIface> CubeFactoryImpl::create_transparent_cube(
  ...
  auto cube = create_transparent_cube(name, ingress_code, egress_code,
                                      log_msg, type, cb, attach, level);
  return std::move(cube);
}
