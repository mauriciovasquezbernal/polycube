...
void print_notification_1() {
  std::cout << "print_notification_1()" << std::endl;
}

void print_notification_2() {
  std::cout << "print_notification_2()" << std::endl;
}
...
int main(int argc, char *argv[]) {
  ...
  // test netlink notifications
  Netlink::getInstance().registerObserver(
      polycube::polycubed::Netlink::Event::ALL, std::bind(print_notification_1));

  polycube::polycubed::Netlink another_instance_;
  another_instance_.registerObserver(
      polycube::polycubed::Netlink::Event::ALL, std::bind(print_notification_2));
